...
func newConversation(db *gorm.DB, opts ...gen.DOOption) conversation {
	...
	_conversation.ConversationID = field.NewString(tableName, "conversation_id")
	_conversation.ConversationType = field.NewString(tableName, "conversation_type")
	_conversation.LastReadMessageID = field.NewString(tableName, "last_read_message_id")
	_conversation.LastReadTime = field.NewTime(tableName, "last_read_time")
	_conversation.UnreadCount = field.NewInt(tableName, "unread_count")
	_conversation.UpdateTime = field.NewTime(tableName, "update_time")
...
type conversation struct {
	...
	ConversationType  field.String
	LastReadMessageID field.String
	LastReadTime      field.Time
	UnreadCount       field.Int
...
func (c *conversation) updateTableName(table string) *conversation {
	...
	c.ConversationType = field.NewString(table, "conversation_type")
	c.LastReadMessageID = field.NewString(table, "last_read_message_id")
	c.LastReadTime = field.NewTime(table, "last_read_time")
	c.UnreadCount = field.NewInt(table, "unread_count")
...
func (c *conversation) fillFieldMap() {
	...
	c.fieldMap["conversation_type"] = c.ConversationType
	c.fieldMap["last_read_message_id"] = c.LastReadMessageID
	c.fieldMap["last_read_time"] = c.LastReadTime
